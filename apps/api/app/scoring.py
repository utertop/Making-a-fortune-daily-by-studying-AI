...
def score_github_repo(repo: dict[str, Any]) -> dict[str, Any]:
    ...
    if stars_delta > 1000:
        score += 25
        reasons.append("stars_delta > 1000: +25")
    elif stars_delta > 100:
        score += 15
        reasons.append("stars_delta > 100: +15")
    elif stars_delta > 0:
        score += 5
        reasons.append("stars_delta > 0: +5")

    if forks_delta > 200:
        score += 10
        reasons.append("forks_delta > 200: +10")
    elif forks_delta > 0:
        score += 5
        reasons.append("forks_delta > 0: +5")

    if latest_stars > 10000:
        score += 10
        reasons.append("stars > 10000: +10")
    elif latest_stars > 1000:
        score += 5
        reasons.append("stars > 1000: +5")

    if latest_forks > 1000:
        score += 5
        reasons.append("forks > 1000: +5")
