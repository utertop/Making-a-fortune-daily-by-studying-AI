...
```json
{"repo_id": 14, "full_name": "Snailclimb/JavaGuide", "url": "https://github.com/Snailclimb/JavaGuide", "description": "Java 面试 & 后端通用面试指南，覆盖计算机基础、数据库、分布式、高并发、系统设计与 AI 应用开发", "language": "Java", "license": "Apache-2.0", "latest_stars": 155162, "latest_forks": 46149, "latest_open_issues": 64, "stars_delta": 28, "forks_delta": 4, "score": 57, "reasons": ["stars_delta > 0: +5", "forks_delta > 0: +5", "stars > 10000: +10", "forks > 1000: +5", "has_license: +5", "has_language: +2", "ai_keyword_match: +15", "latest_commit within 14 days: +10"], "risks": []}
```
